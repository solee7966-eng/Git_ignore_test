...
public class Assume_unchanged_8 {
	...
	*/
		...
		System.out.println("==== Assume_unchanged_8.java 파일 수정이요~입니다. ====");
		System.out.println("==== Assume_unchanged_8.java 파일 두 번째 수정이요~입니다. ====");
		System.out.println("==== Assume_unchanged_8.java 파일 최종본이요~입니다. ====");
